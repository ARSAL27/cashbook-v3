  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <h1 className="login-title">Shops Control Center</h1>
        <p className="login-sub">Sign in with your admin Google account to access all shops</p>
        ...
        <p className="warning-msg">🔒 Access restricted to authorized administrators only.</p>
      </div>
    </div>
  );
};
